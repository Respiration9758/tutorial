# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2020-02-25 03:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result_path', models.CharField(blank=True, default='', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('r1', models.CharField(blank=True, default='', max_length=300)),
                ('r2', models.CharField(blank=True, default='', max_length=300)),
                ('r3', models.CharField(blank=True, default='', max_length=300)),
                ('r4', models.CharField(blank=True, default='', max_length=300)),
                ('r5', models.CharField(blank=True, default='', max_length=300)),
                ('algorithm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snippets.BSP_Algorithm')),
                ('bsp_recognize', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snippets.bsp_c_method')),
            ],
            options={
                'ordering': ('created',),
            },
        ...
        migrations.AddField(
            model_name='bsp_predict_model',
            name='bsp_recognize_s',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snippets.Choice_t_strategy'),
        ),
        migrations.AddField(
            model_name='bsp_predict_model',
            name='f_choice',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snippets.feature_c_method'),
        ),
        migrations.AddField(
            model_name='bsp_predict_model',
            name='tidata',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snippets.TechnicalData'),
        ),
        migrations.AddField(
            model_name='bsp_pre_result',
            name='pre_model',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snippets.BSP_Predict_Model'),
        ),
    ]
